<template>
  <section class="container mt-5">
    ...
    <div v-else>
      <!-- Petit-déjeuner -->
      <div
        v-if="foodStore.meals.breakfast.length > 0"
              ...
              >
                <div class="d-flex flex-column">
                  ...
                  <div class="d-flex align-items-center text-muted">
                    <span class="me-3 nutri"
                      >Calories
                      {{ food.nutrients.calories.amount || 'N/A' }} kcal</span
                    >
                    <span class="me-3 nutri"
                      >Glucides
                      {{ food.nutrients.glucids.amount || 'N/A' }} G</span
                    >
                    <span class="nutri"
                      >Proteines
                      {{ food.nutrients.proteins.amount || 'N/A' }} G</span
                    >
                  </div>
                </div>
                <button
      ...
      <!-- Déjeuner -->
      <div
        v-if="foodStore.meals.lunch.length > 0"
        class="mb-4 d-flex align-items-start"
      >
        <div>
      ...
      <!-- Dîner -->
      <div
        v-if="foodStore.meals.dinner.length > 0"
        class="mb-4 d-flex align-items-start"
      >
        <div>
      ...
      <!-- Snacks -->
      <div
        v-if="foodStore.meals.snacks.length > 0"
        class="mb-4 d-flex align-items-start"
      >
        <div>

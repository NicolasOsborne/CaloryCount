<template>
  <section class="container mt-4">
    <div
      class="card mt-5 shadow-lg rounded"
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col text-center">
            ...
            <p>
              {{ foodStore.totals.all.lipids }} g / {{ nutrientGoals.lipids }} g
            </p>
            <!-- Objectif Lipides dynamique -->
            <div class="progress">
              <div
          ...
          <div class="col text-center">
            ...
            <p>
              {{ foodStore.totals.all.glucids }} g / {{ nutrientGoals.carbs }} g
            </p>
            <!-- Objectif Glucides dynamique -->
            <div class="progress">
              <div
          ...
          <div class="col text-center">
            ...
            <p>
              {{ foodStore.totals.all.proteins }} g /
              {{ nutrientGoals.proteins }} g
            </p>
            <!-- Objectif Protéines dynamique -->
            <div class="progress">
              <div
...
export default defineComponent({
  ...
  computed: {
    ...
    lipidsProgress() {
      return (
        (this.foodStore.totals.all.lipids / this.nutrientGoals.lipids) * 100
      )
    },
    carbsProgress() {
      return (
        (this.foodStore.totals.all.glucids / this.nutrientGoals.carbs) * 100
      )
    },
    proteinsProgress() {
      return (
        (this.foodStore.totals.all.proteins / this.nutrientGoals.proteins) * 100
      )
    },
  },
})
